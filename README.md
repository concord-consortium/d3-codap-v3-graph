...
Merges into production are deployed to http://d3-codap-v3-graph.concord.org.

Other branches are deployed to http://d3-codap-v3-graph.concord.org/branch/<name>.
...
11. Use https://github.com/concord-consortium/d3-codap-v3-graph/releases to create a new release tag
...
D3CodapV3Graph are Copyright 2018 (c) by the Concord Consortium and is distributed under the [MIT license](http://www.opensource.org/licenses/MIT).
